  ...
  async run() {
    ...
    await Card.createMany([
      // Deck: Capitales Europe
      {
        ...
        reponse: 'Paris',
        deck_id: tab_decks['Capitale Europe'],
      },
      {
      ...
      // Deck: Mathématiques
      {
        ...
        reponse: '4',
        deck_id: tab_decks['Mathématiques'],
      },
      {
      ...
      // Deck: Culture Générale
      {
        ...
        deck_id: tab_decks['Culture Générale'],
      },
      {
